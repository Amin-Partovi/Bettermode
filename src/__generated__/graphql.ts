...
export type GetMemberPostQuery = {
  __typename?: "Query";
  memberPosts: {
    __typename?: "PaginatedPost";
    edges?: Array<{
...
export const GetMemberPostDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getMemberPost" },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "hasParent" },
          },
...
} as unknown as DocumentNode<GetMemberPostQuery, GetMemberPostQueryVariables>;
